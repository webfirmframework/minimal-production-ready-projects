...
public final class CookieUtil {
    ...
    // Note: it should be same as in ServerConstants.WFFWEB_TOKEN_COOKIE
    private static final String WFFWEB_TOKEN_COOKIE = "wffwebtoken";
    ...
    public static Cookie createCookie(final String sessionId) {
        return new Cookie(WFFWEB_TOKEN_COOKIE, MultiInstanceTokenUtil.SESSION.createJWT(Map.of(), sessionId));
    }
    ...
    public static Cookie createCookie(final String sessionId, final String loginId) {
        ...
        return new Cookie(WFFWEB_TOKEN_COOKIE, MultiInstanceTokenUtil.SESSION.createJWT(Map.of(), sessionId, loginId));
    }
    ...
    public static MultiInstanceTokenUtil.ParsedPayloadAndClaims getHttpSessionDetails(final HttpServletRequest request) {
        ...
        if (cookies != null) {
            return Arrays.stream(cookies).filter(cookie -> (WFFWEB_TOKEN_COOKIE.equals(cookie.getName()) && cookie.getValue() != null))
