...
public class SampleTemplate1 extends Div implements ServerAsyncMethod {
    ...
    public SampleTemplate1(DocumentModel documentModel) {
        super(null, PureCssClass.CONTAINER.getAttribute());
 ...
 // @formatter:off
    private void develop() {
        ...
        new Form(this, PureCssClass.FORM.getAttribute(), 
                new OnSubmit("event.preventDefault(); return true;", this, null, null)) {{
            new FieldSet(this) {{
        ...
        new Button(this, new OnClick(SampleTemplate1.this), PureCssClass.BUTTON.merge(PureCssClass.BUTTON_PRIMARY)) {{
